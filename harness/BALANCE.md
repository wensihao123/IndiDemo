...
**(f) 敌人数值(逆推自 .tres,非公式、属 per-feature 表,仅列锚点):** 关1 哥布林 hp12 → 兽人 hp28 → Boss 哥布林王 hp90;关2 精英兽人 hp50 → 食人魔 hp85 → Boss 兽人酋长 hp220/atk9。HP 大致几何递增(×1.5~2/档),attack 1→9 线性偏缓。**所有敌人 `item_level` = 默认 1(无一 .tres 覆盖)** ——见 §6 债-1。
